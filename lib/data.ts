...
export const projectsData = [
  {
    title: 'La Furia AI',
    description:
      'A chatbot, video generator, image generator, and music generator, that uses OpenAI API and Replicate. It has a free tier with limited messages, and a pid one with Stripe as payment processor for the subscription.',
    tags: [
      'React',
      'Next.js',
      'MongoDB',
    ...
    link: 'https://la-furia-ai.vercel.app/',
  },
  {
    title: 'Short Term Rentals',
    description:
      'A web app for short-term rental properties, like AirBnB. It features user auth with next-auth, adding properties, maps with leaflet, reservation calendar, modals ui, filtering, and more.',
    tags: [
      'React',
      'TypeScript',
      'Next-Auth',
    ...
    link: 'https://short-term-rentals.vercel.app/',
  },
  {
    title: 'Soluciones iO',
    description:
      'A web development company that helps small business to build their websites using React, Next.JS, WordPress, and WooCommerce.',
    tags: ['React', 'Tailwind', 'Framer Motion'],
    imageUrl: solucionesioImg,
    link: 'https://solucionesio.es',
  },
] as const;
